...
int main()
{
    ...
    int releaseYear;            //Optional, but between1900-2100
    ...
    if (runLength < 0)
    {
        std::cout << "Run length must be a least 0" << std::endl;
        runLength = 0;
    };
...
void relationalDemo()
{
    ...
    // Warning 1 - Equality and equals are similar and work in the samw situations
    ...
    // Warning 3 - Stings compare by character values not by locale
